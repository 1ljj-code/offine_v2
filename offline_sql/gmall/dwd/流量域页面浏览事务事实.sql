...
CREATE
EXTERNAL TABLE dwd_traffic_page_view_inc
(
    `province_id`    STRING,
    `brand`          STRING,
    `channel`        STRING,
...
insert
overwrite table bigdata_offline_v1_ws.dwd_traffic_page_view_inc partition (dt='20250918')
select
